...
module.exports = {
    ...
    API_TZT_withdraw_Base_Url : 'https://ok.yeepay.com/payapi/api/tzt/withdraw',
    API_TZT_Drawrecord_Base_Url:'https://ok.yeepay.com/payapi/api/tzt/drawrecord',
    API_TZT_Paysingle_Base_Url:'https://ok.yeepay.com/merchant/query_server/pay_single',
    API_TZT_AuthBind:"https://ok.yeepay.com/payapi/api/bankcard/authbind/list",
    API_TZT_Check_Bankcard:"https://ok.yeepay.com/payapi/api/bankcard/check",
    API_TZT_invokebindbankcard:"https://ok.yeepay.com/payapi/api/tzt/invokebindbankcard",
    API_TZT_confirmbindbankcard:"https://ok.yeepay.com/payapi/api/tzt/confirmbindbankcard",
    API_TZT_bankcard_unbind:"https://ok.yeepay.com/payapi/api/bankcard/unbind",
    API_TZT_drawvalidamount:"https://ok.yeepay.com/payapi/api/tzt/drawvalidamount",
